...
class DB:
    ...
    def setup(self):
        stmt = "CREATE TABLE IF NOT EXISTS INFO(city text, pincode integer, standard text, board text, medium text, subjects text, number integer, email text, req text, confirm text)"
